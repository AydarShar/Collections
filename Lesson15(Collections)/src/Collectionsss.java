...
public class Collectionsss {
    public static void main(String[] args) {
        ...
        wildCats.add(new Cat.Lion("Симба"));
        wildCats.add(new Cat.Tiger("Тигра"));
        ...
        strokableCats.add(new Cat.SiameseCat("Сиамская"));
        strokableCats.add(new Cat.ThaiCat("Тайская"));
        strokableCats.add(new Cat.SiberianCat("Сибирская"));
        ...
        System.out.println("");
        System.out.println("------------- пункт 7 реализован в классе CatComparator --------------");
        /* пункт 7.
